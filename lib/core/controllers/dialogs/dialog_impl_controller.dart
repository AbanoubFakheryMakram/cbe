...
class DialogImplController implements DialogController {
  BuildContext get context => NavigationController.navigatorKey.currentContext!;
  ...
  Future<T?> showInfoDialog<T>({
    ...
    var result = await _showDialog<T>(
      AlertDialog(
        ...
        actions: <Widget>[
          TextButton(
            onPressed: () => _dimissDialog(context, callback),
            child: actionButton,
          ),
        ],
      ),
